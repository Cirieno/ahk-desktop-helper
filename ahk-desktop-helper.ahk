...
;@Ahk2Exe-Let PName = AHK Desktop Helper, PVersion = 2.5.3.0, PAuthor = Rob McInnes, PCompany = Cirieno Ltd
...
if (__Settings := {}) {
	__Settings.app := {
		...
		build: { version: "2.5.3.0", date: "2024-04", repo: "github.com/cirieno/ahk-desktop-helper" }
	}
